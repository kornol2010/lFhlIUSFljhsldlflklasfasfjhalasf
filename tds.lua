...
Globals.AutoPremium = true
Globals.HasKey = true
Globals.KeyValid = true
...
local function GetEquippedTowers()
    local towers = {}
    local StateReplicators = ReplicatedStorage:FindFirstChild("Staif not Globals.AutoPremium thenteReplicators")
...
local Strategies = Window:Tab({Title = "Strategies", Icon = "newspaper"}) do
    ...
    Strategies:Toggle({
        ...
        Callback = function(v)
            ...
            if v then
                 task.spawn(function()
                    local url = "https://raw.githubusercontent.com/kornol2010/kasinkasd/refs/heads/main/katykafrostv2.lua"
